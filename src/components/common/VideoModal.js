...
const VideoModal = (props) => {
    ...
    return (
        <div className="modal fade" id="videoModal" data-backdrop="static" tabIndex="-1" role="dialog" aria-labelledby="videoModalLabel" aria-hidden="true">
                ...
                <div className="modal-body">
                    {
                        ...
                        <video width="100%" height="auto" autoPlay controls>
                            <source src={ props.event.eventBridgeR.recordingURL } type="video/mp4" />
